...
!!! note
    ...
    Lavalink is essential for processing and streaming audio to Discord. Without a Lavalink server, you won't be able to play music on Vocard. You can either host your own server or use a public Lavalink server from this [Public Lavalink Website](https://lavalink.darrennathanael.com/NoSSL/Lavalink-NonSSL/).

    - Vocard requires **Lavalink v4** or higher.
    - For detailed steps on installing Lavalink, visit the [Lavalink Official Website](https://lavalink.dev/getting-started/index.html).
...
lavalink:
  plugins:
    - dependency: "dev.lavalink.youtube:youtube-plugin:1.13.5"  # Check latest version at https://github.com/lavalink-devs/youtube-source/releases
      snapshot: false
...
=== "Latest"
    ...
    17. You can create your custom buttons in the player controller. [Example Here](../config/controller/#buttons)
...
=== "2.7.1"
    ...
    14.  You can configure the host, password, and enable the IPC client to connect to your Vocard dashboard.
    15.  You can change the source emoji of the track with discord emoji like `<:EMOJI_NAME:EMOJI_ID>` and change the color of the source in [Hexadecimal color](https://htmlcolorcodes.com/){:target="_blank"}.
    16. You can create your custom embeds in the player controller. [Example Here](../config/controller/#music-controller)
